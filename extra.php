      ...
      <div class="sidebar">
        <div class="searchform">
          <form id="formsearch" name="formsearch" method="post" action="index.php">
            <span>
            <input name="product_search" class="editbox_search" id="editbox_search" maxlength="100" placeholder="Search our site:" type="text" />
            </span>&nbsp;&nbsp;&nbsp;
            <input name="button_search" src="images/search.gif" class="button_search" type="submit" value="Search item" />
          </form>
        </div>
        <div class="clr"></div>
