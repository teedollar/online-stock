...
if(isset($_POST['login'])){
  if((!empty($_POST['username'])) && (!empty($_POST['password']))) {
    if($dbConnect->login($_POST['username'], $_POST['password'])){
...
?>
  <div class="fbg">
    <div class="fbg_resize">
      ...
      <div class="col c2">
        <form action="login.php" method="post" id="sendemail">
            <ol><br/><br/><br/>
            <h4> Customer Login Page </h4>
              <li>
              ...
              <li>
                <input type="submit" value= "Sign in"name="login" id="imageField" src="images/submit.gif" class="send" />
              <div class="clr"></div>
              </li><br/>
            </ol>
          </form>
